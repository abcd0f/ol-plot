...
用于在地图上绘制旗帜标绘图形。通过两个控制点确定旗杆长度和旗面展开方向，旗面宽高按固定比例生成。
...
- **绘制方式**：按住拖拽，起点为旗面贴杆侧顶点，终点确定旗杆尾部和旗面展开方向
- **几何类型**：`ol/geom/GeometryCollection`（旗杆 LineString + 旗面 Polygon）
- **坐标表示**：2 个控制点代表旗面贴杆侧顶点和旗杆尾部横向平移到旗面尾边后的点
...
tool.loadPlotData({
  type: 'Flag',
  coordinates: [
    [116.3974, 39.9293], // 旗面贴杆侧顶点
    [116.4174, 39.9093], // 旗杆尾部横向平移到旗面尾边后的点
  ],
  style: {
    strokeColor: '#722ed1',
    strokeWidth: 2,
